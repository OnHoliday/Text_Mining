# -*- coding: utf-8 -*-
"""
Created on Tue Apr  2 00:27:43 2019
...
reviews = pd.read_csv(r"C:\Users\Konrad\Desktop\NOVA IMS\text mining\Project\Amazon\Reviews.csv")
...
embeddings_index = {}
with open(r'C:\Users\Konrad\Desktop\NOVA IMS\text mining\Project\cumberbatch\numberbatch-en-17.02.txt', encoding='utf-8') as f:
    for line in f:
        values = line.split(' ')
        word = values[0]
